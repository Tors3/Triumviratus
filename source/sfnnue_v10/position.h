...
struct StateInfo {
    ...
    // SFNNv10: second accumulator for the Full_Threats feature set (Big net).
    Eval::NNUE::Accumulator<Eval::NNUE::TransformedFeatureDimensionsBig>   accumulatorBigThreat;
    DirtyPiece                                                             dirtyPiece;
    // SFNNv10: per-ply threat delta (Phase B incremental; unused in full-refresh A).

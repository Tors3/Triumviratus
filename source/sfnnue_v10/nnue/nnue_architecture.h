...
#include "features/full_threats_v2.h"
...
// SFNNv10 Big net: L1 = 1024 (was 2560 for the SFNNv8 HalfKA-only b1a57 net).
// TRIUMV_FT_V2 (master nnue-pytorch commit 89d5725): L2 = 31 (NOT 15), fc_0
// outputs 32 instead of 16 = 2x capacity in the head. fc_1 input becomes 62
// (padded to 64 by the writer / by AffineTransform PaddedInputDimensions).
